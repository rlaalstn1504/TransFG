...
def main():
    ...
    parser.add_argument("--dataset", choices=["custom","CUB_200_2011", "car", "dog", "nabirds", "INat2017"], default="CUB_200_2011",
                        help="Which dataset.")
    parser.add_argument('--data_root', type=str, default='/mskim/2_55_experiment/datasets')
    parser.add_argument('--dtype', type= int, default=0)
    parser.add_argument("--model_type", choices=["ViT-B_16", "ViT-B_32", "ViT-L_16",
                                                 "ViT-L_32", "ViT-H_14"],
                        default="ViT-B_16",
                        help="Which variant to use.")
    parser.add_argument("--pretrained_dir", type=str, default="/data/mskim/2_55_experiment/ViT-B_16.npz", 
    #parser.add_argument("--pretrained_dir", type=str, default="/data/mskim/2_55_experiment/imagenet21k_ViT-B_32.npz",
    ...
    parser.add_argument("--train_batch_size", default=23, type=int,
                        help="Total batch size for training.")
    parser.add_argument("--eval_batch_size", default=60, type=int,
